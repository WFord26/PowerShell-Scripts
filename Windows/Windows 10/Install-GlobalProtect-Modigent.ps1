...
.DESCRIPTION
    This Script is for use in Modigent environment.
...
.NOTES
    File Name      : Install-GlobalProtect-Modigent.ps1
    Author         : William Ford
    Prerequisite   : PowerShell V2
.LINK

.EXAMPLE
    Install-GlobalProtect-Modigent.ps1
...
if ($PreCheck -ne $null) {
    ...
    if ($MD5download.Hash -ne $MD5) {
        ...
        Start-Process -FilePath "msiexec.exe" -ArgumentList "/i $MSIPath ALLUSERS=1 /q /norestart /log $logfile " -Wait
    }
}
